...
Riot is in the process of updating League's main texture file format from DDS to their own TEX format; updating groups of champions in alphabetical order. This causes mods to appear broken because Riot's bins are no longer looking for your mod's DDS files.
