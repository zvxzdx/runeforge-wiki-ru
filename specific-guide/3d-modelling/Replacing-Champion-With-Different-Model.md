...
In general, you want the elbow bone where the elbow is, the hip bone where the hip is, etc. If, the arms are too long/too short, use the Move Tool to better fit the model.
